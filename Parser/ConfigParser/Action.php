 ...
 */
abstract class ConfigParser_Action
{
    // Properties {{{
     ...
     *
     * @var ConfigParser_Result $result The result instance
     */
    protected $result;
     ...
     *
     * @var ConfigParser_Option $option The action option
     */
    protected $option;
     ...
     *
     * @var ConfigParser $parser The parser
     */
    protected $parser;
     ...
     * @param ConfigParser_Option $option The action option
     * @param ConfigParser        $parser The current parser
     *
     * @return void
     */
