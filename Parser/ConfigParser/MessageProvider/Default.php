 ...
 */
require_once 'Parser/ConfigParser/MessageProvider.php';
...
/**
 * Lightweight class that manages messages used by ConfigParser package, 
 ...
 */
class ConfigParser_MessageProvider_Default
    implements ConfigParser_MessageProvider,
    ConfigParser_CustomMessageProvider
{
    // Properties {{{
