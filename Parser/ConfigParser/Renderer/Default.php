 ...
 */
require_once 'Parser/ConfigParser/Renderer.php';

/**
 * ConfigParser default renderer.
 *
 * @category  Console
 * @package   ConfigParser
 * @author    David JEAN LOUIS <izimobil@gmail.com>
 ...
 */
class ConfigParser_Renderer_Default implements ConfigParser_Renderer
{
    // Properties {{{
     ...
     * Constructor.
     *
     * @param object $parser A ConfigParser instance
     *
     * @return void
     */
