...
//use ConfigParser\Exception;
//use ConfigParser\Outputter\Default;
//use ConfigParser\Renderer\Default;
//use ConfigParser\MessageProvider\Default;
require_once 'ConfigParser/Exception.php';
require_once 'ConfigParser/Outputter/Default.php';
require_once 'ConfigParser/Renderer/Default.php';
require_once 'ConfigParser/MessageProvider/Default.php';
...
class ConfigParser
{
    ...
    {
        include_once 'ConfigParser/XmlParser.php';
    ...
    public function addArgument($name, $params = array())
    {
        if ($name instanceof ConfigParser_Argument) {
            ...
            include_once 'ConfigParser/Argument.php';
    ...
    public function addCommand($name, $params = array())
    {
        if ($name instanceof ConfigParser_Command) {
            ...
            include_once 'ConfigParser/Command.php';
            $params['name'] = $name;
    ...
    {
        include_once 'ConfigParser/Option.php';
     ...
     *
     * require_once 'ConfigParser.php';
     * require_once 'ConfigParser/Action.php';
     *
    ...
    public function parse($userArgc=null, $userArgv=null)
    {
        ...
        include_once 'ConfigParser/Result.php';
